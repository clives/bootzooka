...
import {notifySuccess, notifyError, userLoggedout} from '../Actions';
...
/*
  export function* getCurrentUser() {
        ...
        yield takeEvery(ActionTypes.GET_CURRENTUSER, function* (action) {
          ...
          try {
            ...
            yield put({ type: ActionTypes.NOTIFY_ERROR, payload: { 'error': "GET_CURRENTUSER:" + error} });
          }
